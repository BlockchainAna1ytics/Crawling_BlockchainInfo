...
class CrawlingBlockInfo(object):
	...
	def get_blockinfo(self):
		...
		self.address = self.address + '?page='
		for a in range(1, self.pages + 1):
			url = "https://www.blockchain.com/btc/address/" + self.address
			url = url + str(a)
...
if __name__ == '__main__':
	a = CrawlingBlockInfo('3DmXG8MDtDn23k7nmxWw3YYenTWPaKbVTF', 5, 'korbit_test.csv')
	a.get_blockinfo()
